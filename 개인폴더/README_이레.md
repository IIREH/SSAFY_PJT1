...
각 케이스마다
1. 기술자들이 당연하게 생각하는 배경지식을 쌓고, *해당 기술이 추구하는 철학과 목표를 잘 이해하여 이 문서를 써내린 사람의 시선에 동기화하는 것*에 유의하고
2. 좀 더 많은 걸 겪어서 소위 짬이라는 게 쌓이면 대충 눈에 들어오는 틀이 생길 거 같고 또
3. 영어공부를 해야겠고 (다행히 기술에 관한 글은 영문학은 아니어서 단어나 문장구조가 반복되는 것 같다)

나름 기술문서부터 찾아보고 읽는다 생각했는데 초보적인 안내나 기초적인 사용법, 튜토리얼 등의 내용이 아니라면 입구컷 당하는 일이 잦다. 좀만 깊게 들어가면 사실상 어느 블로거가 꼭꼭 씹어 소화해 쓴 글로 기초잡고 거기에 레퍼런스라고 달아준 링크로 기술문서를 들어가는 일이 빈번해 참 한심하다.
